...
class CarPhysics:
    ...
    def update(self, dt: float):
        ...
        local_velocity.rotate_around(np.asarray([0, 0]), -self.car.heading)
        ...
        self.velocity.rotate_around(np.asarray([0, 0]), self.car.heading)
    ...
    def get_total_force(self, local_velocity, wheel_torque):
        ...
        wheel_traction = np.asarray([wheel_torque / self.car.wheel_radius, 0])
